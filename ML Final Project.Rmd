...
igraph::write_graph(groceries_graph, file='groceries4.graphml', format = "graphml")

groceries_graph4 = associations2igraph(subset(grocrules, lift>2), associationsAsNodes = FALSE)
igraph::write_graph(groceries_graph, file='groceries2.graphml', format = "graphml")
```
